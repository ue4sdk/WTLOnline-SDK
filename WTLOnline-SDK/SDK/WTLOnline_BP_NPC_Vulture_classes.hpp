...
#include "WTLOnline_BP_NPC_Vulture_structs.hpp"
...
// BlueprintGeneratedClass BP_NPC_Vulture.BP_NPC_Vulture_C
// 0x0028 (0x0B20 - 0x0AF8)
class ABP_NPC_Vulture_C : public AWTLNPCActor
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0AF8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient)
	float                                              Timeline_0_0_NewTrack_0_77B8640A47DC8A3F835604989E7E7990; // 0x0B00(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Timeline_0_0__Direction_77B8640A47DC8A3F835604989E7E7990; // 0x0B04(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_NPC_Vulture.BP_NPC_Vulture_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_NPC_Vulture(int EntryPoint);
};
