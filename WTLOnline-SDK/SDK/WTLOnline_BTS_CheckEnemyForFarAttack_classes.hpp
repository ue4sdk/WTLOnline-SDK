...
#include "WTLOnline_BTS_CheckEnemyForFarAttack_structs.hpp"
...
// BlueprintGeneratedClass BTS_CheckEnemyForFarAttack.BTS_CheckEnemyForFarAttack_C
// 0x0018 (0x00B0 - 0x0098)
class UBTS_CheckEnemyForFarAttack_C : public UBTService_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BTS_CheckEnemyForFarAttack.BTS_CheckEnemyForFarAttack_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BTS_CheckEnemyForFarAttack(int EntryPoint);
};
