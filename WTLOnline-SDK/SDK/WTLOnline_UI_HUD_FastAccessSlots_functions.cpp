...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD_FastAccessSlots.UI_HUD_FastAccessSlots_C.Construct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD_FastAccessSlots.UI_HUD_FastAccessSlots_C.ExecuteUbergraph_UI_HUD_FastAccessSlots"));
