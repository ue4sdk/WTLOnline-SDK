...
#include "WTLOnline_ProceduralMeshComponent_enums.hpp"
...
struct FProcMeshVertex
{
	...
	struct FVector2D                                   UV1;                                                      // 0x0034(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector2D                                   UV2;                                                      // 0x003C(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector2D                                   UV3;                                                      // 0x0044(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
