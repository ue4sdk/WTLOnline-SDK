...
#include "WTLOnline_BP_FurnitureKicthen01_structs.hpp"
...
// BlueprintGeneratedClass BP_FurnitureKicthen01.BP_FurnitureKicthen01_C
// 0x0060 (0x0388 - 0x0328)
class ABP_FurnitureKicthen01_C : public AActor
{
public:
	...
	struct FRotator                                    UpRight;                                                  // 0x0358(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FRotator                                    UpLeft;                                                   // 0x0364(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FRotator                                    DownRight;                                                // 0x0370(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FRotator                                    DownLeft;                                                 // 0x037C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FurnitureKicthen01.BP_FurnitureKicthen01_C"));
		return ptr;
	}
