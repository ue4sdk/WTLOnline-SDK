...
struct FBroadphaseSettings
{
	...
	struct FBox                                        MBPBounds;                                                // 0x0004(0x001C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FKConvexElem : public FKShapeElem
{
	...
	struct FBox                                        ElemBox;                                                  // 0x0040(0x001C) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
