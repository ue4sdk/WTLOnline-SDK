...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass UI_HUD_PlayerStatus_ProgressBar_Item_Small.UI_HUD_PlayerStatus_ProgressBar_Item_Small_C");
		return ptr;
	}
