...
public:
	...
	bool                                               CanAirAttack;                                             // 0x0FEC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0FED(0x0003) MISSED OFFSET
	TArray<struct FLinearColor>                        MonsterColor;                                             // 0x0FF0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
