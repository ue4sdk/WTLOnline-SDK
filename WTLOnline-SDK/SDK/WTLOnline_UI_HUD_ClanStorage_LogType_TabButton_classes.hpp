...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass UI_HUD_ClanStorage_LogType_TabButton.UI_HUD_ClanStorage_LogType_TabButton_C"));
		return ptr;
	}
