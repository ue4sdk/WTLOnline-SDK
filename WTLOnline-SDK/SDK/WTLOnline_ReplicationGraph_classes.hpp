...
#include "WTLOnline_ReplicationGraph_structs.hpp"
...
{
public:
	class UClass*                                      ReplicationConnectionManagerClass;                        // 0x0028(0x0008) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0030(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<class UNetReplicationGraphConnection*>      Connections;                                              // 0x0038(0x0010) (CPF_ZeroConstructor)
	TArray<class UNetReplicationGraphConnection*>      PendingConnections;                                       // 0x0048(0x0010) (CPF_ZeroConstructor)
	unsigned char                                      UnknownData00[0x40];                                      // 0x0058(0x0040) MISSED OFFSET
	TArray<class UReplicationGraphNode*>               GlobalGraphNodes;                                         // 0x0098(0x0010) (CPF_ZeroConstructor)
	TArray<class UReplicationGraphNode*>               PrepareForReplicationNodes;                               // 0x00A8(0x0010) (CPF_ZeroConstructor)
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D*  GridNode;                                                 // 0x02F0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UReplicationGraphNode_ActorList*             AlwaysRelevantNode;                                       // 0x02F8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<struct FConnectionAlwaysRelevantNodePair>   AlwaysRelevantForConnectionList;                          // 0x0300(0x0010) (CPF_ZeroConstructor)
	TArray<class AActor*>                              ActorsWithoutNetConnection;                               // 0x0310(0x0010) (CPF_ZeroConstructor)
...
{
public:
	TArray<class UReplicationGraphNode*>               AllChildNodes;                                            // 0x0028(0x0010) (CPF_ZeroConstructor)
...
public:
	...
	class UReplicationGraphNode*                       DynamicNode;                                              // 0x0140(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UReplicationGraphNode_DormancyNode*          DormancyNode;                                             // 0x0148(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UReplicationGraphNode*                       ChildNode;                                                // 0x0050(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	class AActor*                                      LastViewer;                                               // 0x0110(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class AActor*                                      LastViewTarget;                                           // 0x0118(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TArray<struct FTearOffActorInfo>                   TearOffActors;                                            // 0x0050(0x0010) (CPF_ZeroConstructor)
...
{
public:
	class UNetConnection*                              NetConnection;                                            // 0x0028(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x140];                                     // 0x0030(0x0140) MISSED OFFSET
	class AReplicationGraphDebugActor*                 DebugActor;                                               // 0x0170(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0178(0x0008) MISSED OFFSET
	TArray<class UReplicationGraphNode*>               ConnectionGraphNodes;                                     // 0x0180(0x0010) (CPF_ZeroConstructor)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                              // 0x0190(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UReplicationGraph*                           ReplicationGraph;                                         // 0x0328(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UNetReplicationGraphConnection*              ConnectionManager;                                        // 0x0330(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
